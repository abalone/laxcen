...
<title><spring:message code="menu3"></spring:message></title>
</head>
<c:set var="menuId" value="3" scope="request"/>
<c:set var="submenuNameList" scope="request"><spring:message code="menu3.1"></spring:message>,<spring:message code="menu3.2"></spring:message>,<spring:message code="menu3.3"></spring:message></c:set>
